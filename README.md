...
- [x] [**Awesome ASD**](https://github.com/TaoRuijie/TalkNet_ASD/blob/main/awesomeASD.md): Papers about active speaker detection in last years.
>>>>>>> 7174d26145575c22f5ad7eda6d6d289ee904cb94
...
=======
`AVADataPath` is the folder you want to save the AVA dataset and its preprocessing outputs, the details can be found in [here](https://github.com/TaoRuijie/TalkNet_ASD/blob/main/utils/tools.py#L27) . Please read them carefully.
>>>>>>> 7174d26145575c22f5ad7eda6d6d289ee904cb94
...
=======
We find that it is challenge to apply the model we trained in AVA for the videos not in AVA (Reasons are [here]). So we build TalkSet, an active speaker detection dataset in the wild, based on `VoxCeleb2` and `LRS3`.

We do not plan to upload this dataset since we just modify it instead of building it. Here(`TalkSet`) we provide the `.txt` file to describe which files we used to generate the TalkSet and their ASD labels. You can generate this `TalkSet` if you are interested to train an ASD model in the wild.
>>>>>>> 7174d26145575c22f5ad7eda6d6d289ee904cb94
...
=======
A pretrain model in TalkSet will be download into `TalkNet_ASD/pretrain_TalkSet.model`. Then you can get the following F1 result.

|  Bell  |  Boll  |  Lieb  |  Long  |  Sick  |  Avg.  |
| ------ | ------ | ------ | ------ | ------ | ------ |
|  97.1  |  90.0  |  99.1  |  96.6  |  98.1  |  96.2  |
>>>>>>> 7174d26145575c22f5ad7eda6d6d289ee904cb94
...
<<<<<<< HEAD
We build an end-to-end script to detect and extract the active speaker from the raw video by our pretrain model. Hope this can be used for other audio-visual downsreen tasks.
...
=======
Please let me know if I can future improve in this repositories. Thanks!
>>>>>>> 7174d26145575c22f5ad7eda6d6d289ee904cb94
